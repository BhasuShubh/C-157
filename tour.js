AFRAME.registerComponent('tour', {
        ...
        const thumbnails_ref = [
            {
                ...
                url: './assets/IIT_Bombay.jpg'
            },
            {
                id:'IIT_Kharagpur',
                title: 'IIT Kharagpur Jaunga',
                url: './assets/IIT_Kharagpur.jpg'
            },
            {
                id:'IIT_Madras',
    ...
    title : function(position, item){
        const EntityEl = document.createElement('a-entity')
        EntityEl.setAttribute('visible', true)
        EntityEl.setAttribute('text', {font : 'exo2bold', align: 'center', color: 'black', value: item.id}) 
